...
public class PageListHandlerTest {
    ...
    public void getHandler () throws Exception {
        ...
        Request request = new Request("https://movie.douban.com/");
        ...
        DownloadAjaxPage downloador = new DownloadAjaxPage();
//        result = pageListHandler.handleResponse(request, set, downloador);
    }
